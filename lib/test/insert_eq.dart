            ...
            child: Column(
              children: [
                ...
                Textformfield(
                    ...
                    fieldname: "ผู้ถือครอง"), //user_id
                Textformfield(
                    controller: eq_model.text,
                    fieldname: "รุ่นครุภัณฑ์"), //eq_model
                Textformfield(
                    controller: eq_brand.text,
                    fieldname: "ยี่ห้อครุภัณฑ์"), //eq_brand
                Textformfield(
                    controller: eq_serial.text,
                    fieldname: "หมายเลขซีเรียล"), //eq_serial
                Textformfield(
                    controller: eq_status.text, fieldname: "สถานะ"), //eq_status
                Textformfield(
                    controller: eq_price.text, fieldname: "ราคา"), //eq_price
                Textformfield(
                    controller: eq_date.text,
                    fieldname: "วันที่ซื้อ"), //eq_date
                Textformfield(
                    controller: eq_warran.text,
                    fieldname: "ระยะเวลาประกัน"), //eq_warran
                const SizedBox(height: 20),
